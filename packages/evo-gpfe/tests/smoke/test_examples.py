"""Smoke test: every evo-gpfe example runs end-to-end without error.

The examples live at the repository root (`examples/evo-gpfe/`), outside the
...
EXAMPLES_DIR = Path(__file__).resolve().parents[4] / "examples" / "evo-gpfe"
